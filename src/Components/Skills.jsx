...
const skills = [
  ...
  { name: "JavaScript", level: 95, img: jsLogo },
  { name: "HTML/CSS", level: 95, img: htmlLogo },
  { name: "Node.js", level: 85, img: nodeLogo },
  { name: "MongoDB", level: 80, img: mongoLogo },
  { name: "Bootstrap", level: 80, img: bootstrap },
  { name: "CSS3", level: 80, img: css3 },
  { name: "Express.js", level: 80, img: express },
  { name: "Tailwind", level: 80, img: tailwind },
  { name: "github", level: 80, img: github },
  { name: "Next.js", level: 80, img: next },
